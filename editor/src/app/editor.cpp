...
namespace spright { namespace editor {
	Editor::Editor(RunLoop runLoop): m_RunLoop(runLoop)
	{
		...
		m_DocumentFactory->createUserLayer(m_DocumentStore->getActiveDocument()->getActiveDrawing(), "layer1");
		m_DocumentFactory->createUserLayer(m_DocumentStore->getActiveDocument()->getActiveDrawing(), "layer2");
